...
Package and verify the submission.

## Tasks

| ID | Task | Output | Status |
| --- | --- | --- | --- |
| 7.1.1 | Add E2E happy path | Test script | Planned |
| 7.2.1 | Run auth tests | Test output | Planned |
| 7.2.2 | Run concurrency tests | Test output | Planned |
| 7.2.3 | Run payment idempotency tests | Test output | Planned |
